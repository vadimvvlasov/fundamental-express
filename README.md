...
**9 второстепенных грехов** — каждый даёт свой вес, веса суммируются в **балл**:

| Вес | Грехи |
|---|---|
| **1.0** (ключевые тренды бизнеса) | падение Shareholders Equity · падение FCF (если ещё положительный) · падение выручки · падение операционной прибыли |
...
Максимальный балл — **6.1**. Вердикт при отсутствии критических грехов:
...
только как критический, отдельно как второстепенный тренд — уже нет (раньше задваивалось).
